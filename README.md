...
当前规则版本：`spa-research-profile-v3.2`。官网快照：2026-09-20；规则审阅：2026-09-21。近期窗口为2021–2026年，仅包含快照中已列成果。
...
v3.2补齐S、E细分，原总分、基础档及S/A门槛不变：已归S的75–79分为S-、80–84分为S、85–100分为S+；已归E的0–4分为E-、5–9分为E、10–14分为E+。A至D沿用原细分区间。75分及以上未过S门槛仍可留在A+，未过A门槛的60分及以上记录仍为B+。“+”不代表晋级。公开数据继续用 `evidenceGrade` 保留基础档，用 `evidenceSubgrade` 提供显示档位；统计同时保留基础档与细分分布。
